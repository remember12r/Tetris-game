    ...
    while True:
        ...
        if count == 30:
            ...
            if winx[1] > winy[1] and winx[0] == 0:
                rocket = 3
                cv2.putText(frame, "direction : " + "left", (100, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (50, 170, 50),
                            2);

            elif winx[1] > winy[1] and winx[0] == 1:
                rocket = 4
                cv2.putText(frame, "direction : " + "right", (100, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (50, 170, 50),
                            2);
            if winy[1] > winx[1] and winy[0] == 0:
                ...
                rocket = 2
                cv2.putText(frame, "direction : " + "down", (100, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (50, 170, 50),
                            2);
        ...
        cv2.putText(frame, "box : " + str(int(bbox[0])) + "," + str(int(bbox[1])) + "," + str(int(bbox[2])) + "," + str(
            int(bbox[3])), (100, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (50, 170, 50), 2);
...
def main():
    ...
    class Figure:
        ...
        def __init__(self, x, y):
            self.x = x
            self.y = y
            self.type = random.randint(0, len(self.figures) - 1)  # 方块图案
            self.color = random.randint(1, len(colors) - 1)  # 方块颜色
            self.rotation = 0
